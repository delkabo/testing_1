...
class Dogs(Animal):
    ...
    def walk(self):
        return f"{self.name} walk on the {self.walked}, and do {self.sounds}"
    
name=input("What's name of dog: ")
sound=input("How is sound a dog: ")
walk=input("Where he is walk: ")
mydog = Dogs(name, sound, walk)
